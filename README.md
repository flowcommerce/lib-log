...
Then, to add the Rollbar logger to a project:
  ...
  - Add [logback.xml](https://github.com/flowcommerce/misc/blob/main/log/templates/logback.xml) and [logback-test.xml](https://github.com/flowcommerce/misc/blob/main/log/templates/logback-test.xml) to `api/conf`
