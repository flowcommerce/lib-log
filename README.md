...
Then, to add the Rollbar logger to a project:
  ...
  - Add [logback.xml](https://github.com/flowcommerce/misc/blob/primary/log/templates/logback.xml) and [logback-test.xml](https://github.com/flowcommerce/misc/blob/primary/log/templates/logback-test.xml) to `api/conf`
...
Lastly, to use Rollbar:
  ...
  - Look at the [source code](https://github.com/flowcommerce/lib-log/blob/primary/src/main/scala/io/flow/log/Rollbar.scala#L159) to see how it works under the hood
